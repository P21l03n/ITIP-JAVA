...
/**
 * Этот класс представляет собой пользовательский компонент Swing для представления 
 * одной ячейки карты на 2D-карте. Ячейка имеет несколько состояний, 
 * независимо от того, является ли ячейка проходимой или нет.
 */
