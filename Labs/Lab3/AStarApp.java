 ...
 * Пользователь может нарисовать или устранить препятствия на карте, а затем нажать кнопку, 
 * чтобы вычислить путь от начала до конца, используя алгоритм поиска пути A *. 
