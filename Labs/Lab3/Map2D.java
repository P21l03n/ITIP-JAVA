...
public class Map2D
{
    ...
    public Map2D(int width, int height)
    {
        ...
        // Составьте несколько координат для старта и финиша.
     ...
     * находятся ли они в пределах границ карты. Если координаты не находятся на карте, 
    ...
    /** Возвращает значение true, если location содержится в области карты. **/
    ...
    /**
     * Возвращает конечное местоположение для карты. На этом сгенерированный путь завершится.
     **/
