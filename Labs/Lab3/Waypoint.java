...
public class Waypoint
{
    ...
    /**
     * Предыдущая путевая точка на этом пути или <код>null</code>, если это корень поиска A*.
     **/
    Waypoint prevWaypoint;

    /**
     * В этом поле хранится общая предыдущая стоимость проезда от начального местоположения
     * до этой путевой точки по цепочке путевых точек. Это фактическая стоимость следования по пути; 
     ...
     * Необязательно может быть указана предыдущая путевая точка, 
     * или ссылка может быть <code>null</code>, чтобы указать, что путевая точка является началом пути.
     **/
     ...
     * так и оставшуюся стоимость в одном вызове метода. Обычно эти значения
    ...
    /**
     * Возвращает фактическую стоимость проезда до этой точки 
     * из начального местоположения через ряд путевых точек в этой цепочке.
     **/
